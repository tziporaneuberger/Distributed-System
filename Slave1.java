...
public class Slave1 {
	...
	public static void main(String[] args) throws IOException {    
    	...
    	args = new String[] {"192.168.1.5", "30122"};
        ...
        try (
    		...
    		Slave1 thisSlave = new Slave1(id);
    		...
    		while(thisSlave.IsReceivingAnyMoreJobs()) {
    			...
    			if((input = readerFromMaster.readLine()) != null) {
    				...
    				if (integerInput != JOBS_ARE_COMPLETE) {
        				thisSlave.addToThisSlavesQueue(integerInput);
